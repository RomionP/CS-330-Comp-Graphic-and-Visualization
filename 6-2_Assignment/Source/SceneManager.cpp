...
void SceneManager::SetupSceneLights()
{
	...
	//Light source 1
	m_pShaderManager->setVec3Value("lightSources[0].position", 6.0f, 10.0f, 12.0f);
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", 0.12f, 0.08f, 0.09f);
	m_pShaderManager->setVec3Value("lightSources[0].diffuseColor", 0.75f, 0.6f, 0.62f);
	m_pShaderManager->setVec3Value("lightSources[0].specularColor", 0.6f, 0.5f, 0.5f);
	...
	//Light source 2
	m_pShaderManager->setVec3Value("lightSources[1].position", -8.0f, 6.0f, 3.0f);
	...
	//Light source 4
	m_pShaderManager->setVec3Value("lightSources[3].position", -5.0f, 8.0f, 1.0f);
	m_pShaderManager->setVec3Value("lightSources[3].ambientColor", 0.03f, 0.03f, 0.03f);;
	m_pShaderManager->setVec3Value("lightSources[3].diffuseColor", 0.05f, 0.05f, 0.05f);
	...
	// turn on the lighting for the 3D scene
...
void SceneManager::RenderScene()
{
	...
	SetShaderColor(0.85f, 0.55f, 0.6f, 1.0f);
	...
	// set the active color values in the shader (RGBA)
	SetShaderColor(0.85f, 0.55f, 0.6f, 1.0f);
	//set the active material values in the shader
	SetShaderMaterial("tile");
	...
	// set the active color values in the shader (RGBA)
	SetShaderColor(0.88f, 0.75f, 0.78f, 1.0f);
	//set the active material values in the shader
	SetShaderMaterial("tile");
